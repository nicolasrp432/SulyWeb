...
const WhatsAppButton = ({ phoneNumber }) => {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-24 right-6 z-50 w-14 h-14 bg-gradient-to-r from-green-400 to-green-600 rounded-full flex items-center justify-center shadow-lg text-white"
